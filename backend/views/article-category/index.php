...
<table class="table table-bordered table-responsive">
    ...
    <?php foreach ($model as $row):?>
        <tr data-field="<?=$row->id?>">
            ...
            <td><?php echo $row->is_delete?\yii\bootstrap\Html::a("恢复",["article-category/delete","id"=>$row->id],["class"=>"btn btn-warning"]):\yii\bootstrap\Html::a("删除",null,["class"=>"btn btn-danger"])?>
