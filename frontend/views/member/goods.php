    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <?php foreach ($img as $i):?>
                                <li>
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$i->path?>',largeimage: '<?=$i->path?>'}"><img src="<?=$i->path?>"></a>
                            </li>
                            <?php endforeach;?>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?=\yii\helpers\Url::to(['cart/cate-success'])?>" method="get" class="choose">
                    <ul>
                        <li>
                            <dl>
                                <dt>购买数量：</dt>
                        ...
                        <li>
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <input type="hidden" value="<?=$model->id?>" name="goods_id" class="add_btn" />
                                </dd>
                            </dl>
                        </li>
                    </ul>
