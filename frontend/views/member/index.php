...
<div class="topnav">
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>您好，欢迎来到京西！<?=Yii::$app->user->isGuest?'[<a href="login.html">登录</a>] [<a href="register.html">免费注册</a>]':Yii::$app->user->identity->username.'[<a href="logout.html">退出</a>]'?> </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
    ...
    <div class="logo w1210">
        ...
        <div class="user fl">
            <dl>
                ...
                <dd>
                    <div class="prompt">
                        <?=Yii::$app->user->isGuest?'您好，请<a href="">登录</a>':'你好,'.Yii::$app->user->identity->username?>
                    </div>
                    <div class="uclist mt10">
                        <ul class="list1 fl">
                            <li><a href="">用户信息></a></li>
                            <li><a href="<?=\yii\helpers\Url::to(['order/order'])?>">我的订单></a></li>
                            <li><a href="<?=\yii\helpers\Url::to(['address/address'])?>">收货地址></a></li>
                            <li><a href="">我的收藏></a></li>
                        </ul>
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                ...
                <div class="cat item1">
                    <h3><a href="<?=\yii\helpers\Url::to(['member/list','id'=>$v->id])?>"><?=$v->name?></a> <b></b></h3>


                    <div class="cat_detail">
                        <?php $m = \frontend\models\GoodsCategory::find()->where(['parent_id'=>$v->id])->all(); foreach ($m as $n): ?>

                        <dl class="dl_1st">
                            <dt><a href="<?=\yii\helpers\Url::to(['member/list','id'=>$n->id])?>"><?=$n->name?></a></dt>
                            <dd>
                                <?php  $s=\frontend\models\GoodsCategory::find()->where(['parent_id'=>$n->id])->all(); foreach ($s as $x): ?>
                                <a href="<?=\yii\helpers\Url::to(['member/list','id'=>$x->id])?>"><?=$x->name?></a>
                                <?php endforeach;?>
                            </dd>
