...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        <tbody>
        <?php $sum =0;if (!empty($cookies)):foreach ($cookies as $id =>$cookie):?>
            <?php $good = \frontend\models\Goods::findOne(['id'=>$id])?>
            <tr  data-id="<?=$id?>">
            ...
            <td class="col4">
                ...
                <input type="text" name="amount" value="<?=$cookie?>" class="amount"/>
                <a href="javascript:;" class="add_num"></a>
            </td>
            <td class="col5">￥<span><?=$good->shop_price*$cookie;$sum+=$good->shop_price*$cookie;?></span></td>
            <td class="col6"><a href="" class="delete">删除</a></td>
        </tr>
        <?php endforeach;?>
        <?php endif;?>
        </tbody>
