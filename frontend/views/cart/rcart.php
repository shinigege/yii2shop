        ...
        <?php $sum = 0;foreach ($cookies as $cookie): ?>
            <tr data-id="<?= $cookie->goods_id ?>">
                ...
                <td class="col1"><a href=""><img src="<?= $good->logo ?>" alt=""/></a> <strong><a
                                href=""><?= $good->name ?></a></strong></td>
                <td class="col3">￥<span><?= $good->shop_price ?></span></td>
                <td class="col4">
                    <a href="javascript:;" class="reduce_num"></a>
                    <input type="text" name="amount" value="<?= $cookie->amount ?>" class="amount"/>
                    <a href="javascript:;" class="add_num"></a>
                </td>
                <td class="col5">￥<span><?= $good->shop_price * $cookie->amount;
                        $sum += $good->shop_price * $cookie->amount; ?></span></td>
